...
public:
    Entity(glm::vec2 pos, glm::vec2 size, glm::vec2 vel, glm::vec2 scale, glm::vec4 color = { 1.0f, 1.0f, 1.0f, 1.0f });    
    ~Entity() {}
    ...
    inline const glm::vec2& get_scale() const { return this->body.scale; }
